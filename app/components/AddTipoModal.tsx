...
export default function AddTipoModal({
  isOpen,
  closeModal,
  pokemonId,
  tiposDisponibles,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success('Tipos añadidos correctamente');
      onTipoAdded();
      closeModal();
    } catch (error) {
      console.error('Error:', error);
      toast.error('Error al añadir tipos');
    } finally {
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-gray-800 p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-6 flex justify-end space-x-3">
                  ...
                  >
                    {isSubmitting ? 'Añadiendo...' : 'Añadir Tipos'}
                  </button>
                </div>
              </Dialog.Panel>
            </Transition.Child>
